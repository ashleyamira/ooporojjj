...
namespace Final_Project
{
    public partial class Form1 : Form
    {
        ...
        int playerScore;
        int enemyScore;
        internal static object wplayer;
        ...
        {
            Form3 battle = new Form3();
            var result = battle.ShowDialog();

            if (result == DialogResult.OK)
            {
                MessageBox.Show("You won! Here's your hint: 🧠");
                // show actual hint here or display in a label
            }
            else
            {
                MessageBox.Show("You lost! Better luck next round.");
            }
        }
    }
}
